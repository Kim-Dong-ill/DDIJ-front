            ...
            <div className="flex gap-3 items-center">
              ...
              <div>
                ...
                <div className="flex gap-[3px]">
                  <p className="nanum text-sm whitespace-nowrap">약속시간 </p>
                  <span className="text-da-200 nanum text-sm">19시 00분</span>
                </div>
                <div className="flex gap-[3px]">
                  <p className="nanum text-sm whitespace-nowrap">출발장소 </p>
                  <span className="text-da-200 nanum text-sm">
                    가산 디지털단지역 코드랩 아카데미 건물 앞
                  </span>
                </div>
              </div>
            </div>
